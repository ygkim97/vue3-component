...
<template>
  ...
  <EdgeLabelRenderer>
    ...
    >
      <button class="edge-delete-button" @click="$emit('removeEdge', id)">×</button>
    </div>
  </EdgeLabelRenderer>
</template>
...
<style>
.edge-delete-button {
  @apply w-4 h-4 bg-blue-900 text-white flex justify-center items-center rounded-full text-xs;
}
</style>
